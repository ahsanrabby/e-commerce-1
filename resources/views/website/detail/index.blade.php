            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="breadcrumbs-content">
                        <h1 class="page-title text-primary">Product Details</h1>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            <h1 class="title text-primary">{{$product->name}}</h1>
                            <p class="category "><i class="lni lni-tag"></i> Product Model:
                                <a href="javascript:void(0)" class="text-info h4">{{$product->model}}</a>
                            </p>
                            <p class="category "><i class="lni lni-tag"></i> Product Category:
                                <a href="javascript:void(0)" class="text-info h4">{{$product->category->name}}</a>
                            </p>
                            <p class="category "><i class="lni lni-tag"></i> Product Sub Category:
                                <a href="javascript:void(0)" class="text-info h4">{{$product->subCategory->name}}</a>
                            </p>
                            <p class="category "><i class="lni lni-tag"></i> Product Brand:
                                <a href="javascript:void(0)" class="text-info h5">{{$product->brand->name}}</a>
                            </p>
                            <h3 class="price text-success">৳ BDT  {{$product->selling_price}}<span class="text-danger">৳ BDT {{$product->regular_price}}</span></h3>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-4 col-md-4 col-12">
                                            <div class="button cart-button">
                                                <button type="submit" class="btn btn" style="width: 100%;">Add to Cart</button>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-12">
            ...
            <div class="product-details-info">
                ...
                <div class="row">
                    <div class="col-lg-4 col-12">
                        <div class="p-3 m-3">
                            <a href="{{route('user.review',['id'=> $product->id])}} " class="btn btn-outline-danger">Add a Public Comments</a>
                        </div>
                                ...
                                <div class="single-review">
                                    ...
                                    @foreach($cmt as $comment)
                                        <div class="review-info mt-4">
                                            <h4>
                                                {{$comment->comments}}
                                                <span class="text-success">{{$comment->name}}
</span>
                                            </h4>
                                            <ul class="stars">
