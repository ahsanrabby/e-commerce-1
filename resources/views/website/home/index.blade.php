                ...
                <div class="col-lg-4 col-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                            ...
                            <div class="hero-small-banner card shadow-lg" style="background-image: url('{{asset('/')}}website/assets/images/hero/slider-bnr.jpg');">
                                <div class="content ">
                                    <h2>
                        ...
                        <div class="col-lg-12 col-md-6 col-12">
                            ...
                            <div class="hero-small-banner card shadow-lg style2">
                                <div class="content">
                                    <h2>Weekly Sale!</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2 class="text-primary " id="featured_category">Featured Categories</h2>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category  shadow-lg">
    ...
    <section class="trending-product section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2 id="trending" class="text-primary"> Trending Product</h2>
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                            suffered alteration in some form.</p>
                    </div>
                </div>
    ...
    <section class="special-offer section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2 class="text-primary">Special Offer</h2>
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                            suffered alteration in some form.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="offer-content">
                        ...
                        <div class="text">
                            ...
                            <div class="price">
                                <span>৳ BDT 21,200.00</span>
                                <span class="discount-price">৳ BDT 4400.00</span>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
                    <h4 class="list-title text-info">Best Sellers</h4>
                    ...
                    <div class="single-list">
                        ...
                        <div class="list-info">
                            ...
                            <span>৳ BDT 85120.00</span>
                        </div>
                    </div>

                </div>
                <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
                    <h4 class="list-title text-success">New Arrivals</h4>
                    ...
                    <div class="single-list">
                        ...
                        <div class="list-info">
                            ...
                            <span>৳ BDT 298.00</span>
                        </div>
                    </div>

                </div>
                <div class="col-lg-4 col-md-4 col-12">
                    <h4 class="list-title text-info">Top Rated</h4>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-12 col-12">
                    <h2 class="title text-primary">Popular Brands</h2>
                </div>
            </div>
    ...
    <section class="blog-section section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2 class="text-primary">Our Latest News</h2>
