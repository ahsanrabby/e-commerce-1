            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="breadcrumbs-content">
                        <h1 class="page-title text-primary">checkout</h1>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="">
                                                    <level><input type="radio" checked name="payment_type" value="1"> Cash On Delivery</level>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="col-md-12 form-input form">
                                                    @if(isset($customer->id))
                                                    <input type="text" name="name" class="form-control" value="{{$customer->name}}" id="customer_name" placeholder="Full Name" readonly required>
                                                    @else
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @if(isset($customer->id))
                                                    <input type="number" name="mobile" class="form-control" value="{{$customer->mobile}}" id="mobile" placeholder="Mobile" readonly required>
                                                    @else
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="col-md-12 form-input form">
                                                    @if(isset($customer->id))
                                                    <input type="email" name="email" class="text-muted" value="{{$customer->email}}" id="email" placeholder="you@example.com" readonly required>
                                                    @else
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                <label>Payment Type</label>
                                                <div class="p-2">
                                                    <level><input type="radio" class="p-2" checked name="payment_type" value="2">Online</level>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                        ...
                        <div class="checkout-sidebar-price-table">
                            ...
                            <div class="total-payable">
                                ...
                                <div class="payable-price">
                                    ...
                                    <p class="price">{{$tax = round(($total*10)/100)}}</p>
                                </div>
                                <div class="payable-price">
