                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal p-t-20" action="{{route('sub-category.update',  ['id' => $sub_category->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" class="form-control" name="description" id="exampleInputEmail3" placeholder="Category Description">{{$sub_category->description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <level class="me-3"><input type="radio" name="status" {{$sub_category->status == 1 ? 'checked' : ''}} value="1" checked> Published </level>
                                <level><input type="radio" name="status" {{$sub_category->status == 2 ? 'checked' : ''}} value="2"> Unpublished </level>
                            </div>
                        </div>
